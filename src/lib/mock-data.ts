...
export const MOCK_JOBS: JobListing[] = [
  {
    ...
    address: "Rod. BR-163, Km 502, Distrito Industrial",
    contract_type: "CLT",
    salary_min: 3200,
    salary_max: 4200,
  ...
  },
  {
    ...
    city: "Sinop",
    neighborhood: "Centro",
    address: "Av. das Itaúbas, 1450, sala 3",
    contract_type: "CLT",
    salary_min: 1800,
    salary_max: 2200,
  ...
  },
  {
    ...
    address: "Av. Governador Júlio Campos, 890",
    contract_type: "CLT",
    salary_min: 1600,
    salary_max: null,
  ...
  },
  {
    ...
    address: "Rua das Acácias, 320, próximo à praça",
    contract_type: "CLT",
    salary_min: 1500,
    salary_max: 1800,
  ...
  },
  {
    ...
    city: "Sinop",
    neighborhood: "Setor Industrial",
    address: "Rod. BR-163, Km 498, pátio de cargas",
    contract_type: "CLT",
    salary_min: 2800,
    salary_max: 3500,
  ...
  },
  {
    ...
    city: "Sinop",
    neighborhood: "Setor Industrial",
    address: "Rod. BR-163, Km 505, portão 2",
    contract_type: "CLT",
    salary_min: 1650,
    salary_max: 1900,
  ...
  },
  {
    ...
    city: "Sinop",
    neighborhood: "Centro",
    address: "Av. das Itaúbas, 1450, sala 8",
    contract_type: "CLT",
    salary_min: 4000,
    salary_max: 5500,
  ...
  },
  {
    ...
    city: "Sinop",
    neighborhood: "Setor Industrial",
    address: "Rod. BR-163, Km 502, sede administrativa",
